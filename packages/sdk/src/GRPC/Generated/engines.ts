  ...
  constructor() {
    super("gooseai.EngineInfo", [
      ...
      { no: 3, name: "ready", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
      {
        ...
        name: "type",
        kind: "enum",
        T: () => ["gooseai.EngineType", EngineType],
      },
      {
        no: 5,
        name: "tokenizer",
        kind: "enum",
        T: () => ["gooseai.EngineTokenizer", EngineTokenizer],
      },
...
class Engines$Type extends MessageType<Engines> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated gooseai.EngineInfo engine */ 1:
          message.engine.push(
            EngineInfo.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.engine.length; i++)
      EngineInfo.internalBinaryWrite(
        message.engine[i],
