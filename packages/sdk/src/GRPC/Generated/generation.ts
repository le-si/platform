...
class CAIParameters$Type extends MessageType<CAIParameters> {
    constructor() {
        super("gooseai.CAIParameters", [
            { no: 1, name: "model_metadata", kind: "enum", oneof: "parameters", T: () => ["gooseai.CAIParameters.ModelMetadata", CAIParameters_ModelMetadata, "MODEL_METADATA_"] }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CAIParameters): CAIParameters {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CAIParameters, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class ImageParameters$Type extends MessageType<ImageParameters> {
    constructor() {
        super("gooseai.ImageParameters", [
            ...
            { no: 11, name: "cai_parameters", kind: "message", T: () => CAIParameters }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional gooseai.CAIParameters cai_parameters */ 11:
                    message.caiParameters = CAIParameters.internalBinaryRead(reader, reader.uint32(), options, message.caiParameters);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: ImageParameters, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.caiParameters)
            CAIParameters.internalBinaryWrite(message.caiParameters, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
