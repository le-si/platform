    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated gooseai.Token tokens */ 1:
          message.tokens.push(
            Token.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
...
class Artifact$Type extends MessageType<Artifact> {
  constructor() {
    super("gooseai.Artifact", [
      ...
      { no: 8, name: "index", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
      {
        ...
        name: "finish_reason",
        kind: "enum",
        T: () => ["gooseai.FinishReason", FinishReason],
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* gooseai.Tokens tokens */ 7:
          message.data = {
            oneofKind: "tokens",
            tokens: Tokens.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.data as any).tokens
            ),
          };
          break;
        case /* gooseai.ClassifierParameters classifier */ 11:
          message.data = {
            oneofKind: "classifier",
            classifier: ClassifierParameters.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.data as any).classifier
            ),
          };
          break;
  ...
  internalBinaryWrite(
    ...
    if (message.data.oneofKind === "classifier")
      ClassifierParameters.internalBinaryWrite(
        message.data.classifier,
...
class Prompt$Type extends MessageType<Prompt> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* optional gooseai.PromptParameters parameters */ 1:
          message.parameters = PromptParameters.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.parameters
        ...
        case /* gooseai.Artifact artifact */ 4:
          message.prompt = {
            oneofKind: "artifact",
            artifact: Artifact.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.prompt as any).artifact
            ),
          };
          break;
        default:
  ...
  internalBinaryWrite(
    ...
    if (message.parameters)
      PromptParameters.internalBinaryWrite(
        message.parameters,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* optional gooseai.Model conditioner */ 2:
          message.conditioner = Model.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.conditioner
...
class StepParameter$Type extends MessageType<StepParameter> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* optional gooseai.SamplerParameters sampler */ 2:
          message.sampler = SamplerParameters.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.sampler
        ...
        case /* optional gooseai.ScheduleParameters schedule */ 3:
          message.schedule = ScheduleParameters.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.schedule
        ...
        case /* optional gooseai.GuidanceParameters guidance */ 4:
          message.guidance = GuidanceParameters.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.guidance
  ...
  internalBinaryWrite(
    ...
    if (message.sampler)
      SamplerParameters.internalBinaryWrite(
        message.sampler,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.schedule)
      ScheduleParameters.internalBinaryWrite(
        message.schedule,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.guidance)
      GuidanceParameters.internalBinaryWrite(
        message.guidance,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class CutoutParameters$Type extends MessageType<CutoutParameters> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated gooseai.CutoutParameters cutouts */ 1:
          message.cutouts.push(
            CutoutParameters.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.cutouts.length; i++)
      CutoutParameters.internalBinaryWrite(
        message.cutouts[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class GuidanceScheduleParameters$Type extends MessageType<GuidanceScheduleParameters> {
  ...
  create(
    value?: PartialMessage<GuidanceScheduleParameters>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GuidanceScheduleParameters
  ): GuidanceScheduleParameters {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    ...
    /* float value = 2; */
    if (message.value !== 0) writer.tag(2, WireType.Bit32).float(message.value);
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
...
class GuidanceInstanceParameters$Type extends MessageType<GuidanceInstanceParameters> {
  ...
  create(
    value?: PartialMessage<GuidanceInstanceParameters>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GuidanceInstanceParameters
  ): GuidanceInstanceParameters {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated gooseai.Model models */ 2:
          message.models.push(
            Model.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
        ...
        case /* repeated gooseai.GuidanceScheduleParameters schedule */ 4:
          message.schedule.push(
            GuidanceScheduleParameters.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
        ...
        case /* optional gooseai.CutoutParameters cutouts */ 5:
          message.cutouts = CutoutParameters.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.cutouts
        ...
        case /* optional gooseai.Prompt prompt */ 6:
          message.prompt = Prompt.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.prompt
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.schedule.length; i++)
      GuidanceScheduleParameters.internalBinaryWrite(
        message.schedule[i],
        writer.tag(4, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class GuidanceParameters$Type extends MessageType<GuidanceParameters> {
  constructor() {
    super("gooseai.GuidanceParameters", [
      {
        no: 1,
        name: "guidance_preset",
        kind: "enum",
        T: () => ["gooseai.GuidancePreset", GuidancePreset, "GUIDANCE_PRESET_"],
      },
      {
        no: 2,
        name: "instances",
      ...
      switch (fieldNo) {
        ...
        case /* repeated gooseai.GuidanceInstanceParameters instances */ 2:
          message.instances.push(
            GuidanceInstanceParameters.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.instances.length; i++)
      GuidanceInstanceParameters.internalBinaryWrite(
        message.instances[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    super("gooseai.TransformType", [
      {
        ...
        kind: "enum",
        oneof: "type",
        T: () => ["gooseai.DiffusionSampler", DiffusionSampler],
      },
      {
        no: 2,
        name: "upscaler",
        kind: "enum",
        oneof: "type",
        T: () => ["gooseai.Upscaler", Upscaler, "UPSCALER_"],
      },
    ]);
  }
...
class ImageParameters$Type extends MessageType<ImageParameters> {
  constructor() {
    super("gooseai.ImageParameters", [
      ...
      {
        no: 8,
        name: "masked_area_init",
        kind: "enum",
        opt: true,
        T: () => [
          "gooseai.MaskedAreaInit",
          MaskedAreaInit,
          "MASKED_AREA_INIT_",
        ],
      },
      {
        ...
        kind: "enum",
        opt: true,
        T: () => ["gooseai.WeightMethod", WeightMethod],
      },
      {
        no: 10,
        name: "quantize",
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated uint32 seed */ 3:
          ...
          else message.seed.push(reader.uint32());
          break;
        ...
        case /* optional gooseai.TransformType transform */ 6:
          message.transform = TransformType.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.transform
        ...
        case /* repeated gooseai.StepParameter parameters */ 7:
          message.parameters.push(
            StepParameter.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
  ...
  internalBinaryWrite(
    ...
    if (message.transform)
      TransformType.internalBinaryWrite(
        message.transform,
        writer.tag(6, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    for (let i = 0; i < message.parameters.length; i++)
      StepParameter.internalBinaryWrite(
...
class ClassifierCategory$Type extends MessageType<ClassifierCategory> {
  constructor() {
    super("gooseai.ClassifierCategory", [
      ...
      },
      {
        ...
        kind: "enum",
        opt: true,
        T: () => ["gooseai.Action", Action, "ACTION_"],
      },
      {
        no: 5,
        ...
        kind: "enum",
        opt: true,
        T: () => ["gooseai.ClassifierMode", ClassifierMode],
      },
    ]);
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated gooseai.ClassifierConcept concepts */ 2:
          message.concepts.push(
            ClassifierConcept.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.concepts.length; i++)
      ClassifierConcept.internalBinaryWrite(
        message.concepts[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class ClassifierParameters$Type extends MessageType<ClassifierParameters> {
      ...
      switch (fieldNo) {
        case /* repeated gooseai.ClassifierCategory categories */ 1:
          message.categories.push(
            ClassifierCategory.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.categories.length; i++)
      ClassifierCategory.internalBinaryWrite(
  ...
  constructor() {
    super("gooseai.InterpolateParameters", [
      ...
      },
      {
        ...
        kind: "enum",
        opt: true,
        T: () => ["gooseai.InterpolateMode", InterpolateMode],
      },
    ]);
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated float ratios */ 1:
          ...
          else message.ratios.push(reader.float());
          break;
  ...
  constructor() {
    super("gooseai.TransformColorAdjust", [
      ...
      { no: 6, name: "match_image", kind: "message", T: () => Artifact },
      {
        ...
        kind: "enum",
        opt: true,
        T: () => ["gooseai.ColorMatchMode", ColorMatchMode],
      },
      {
        no: 8,
        name: "noise_amount",
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* optional gooseai.Artifact match_image */ 6:
          message.matchImage = Artifact.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.matchImage
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated float data = 1 [packed = true];*/ 1:
          ...
          else message.data.push(reader.float());
          break;
        default:
          let u = options.readUnknownField;
          if (u === "throw")
...
class TransformResample$Type extends MessageType<TransformResample> {
    ...
    super("gooseai.TransformResample", [
      {
        ...
        name: "border_mode",
        kind: "enum",
        T: () => ["gooseai.BorderMode", BorderMode],
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* gooseai.TransformMatrix transform */ 2:
          message.transform = TransformMatrix.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.transform
        ...
        case /* optional gooseai.TransformMatrix prev_transform */ 3:
          message.prevTransform = TransformMatrix.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.prevTransform
          );
          break;
  ...
  internalBinaryWrite(
    ...
    if (message.transform)
      TransformMatrix.internalBinaryWrite(
        message.transform,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    super("gooseai.CameraParameters", [
      {
        ...
        name: "camera_type",
        kind: "enum",
        T: () => ["gooseai.CameraType", CameraType],
      },
...
class TransformCameraPose$Type extends MessageType<TransformCameraPose> {
  constructor() {
    super("gooseai.TransformCameraPose", [
      ...
      { no: 5, name: "do_prefill", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
      {
        ...
        name: "render_mode",
        kind: "enum",
        T: () => ["gooseai.RenderMode", RenderMode],
      },
    ]);
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* gooseai.TransformMatrix world_to_view_matrix */ 1:
          message.worldToViewMatrix = TransformMatrix.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.worldToViewMatrix
          );
          break;
        case /* gooseai.CameraParameters camera_parameters */ 2:
          message.cameraParameters = CameraParameters.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.cameraParameters
  ...
  internalBinaryWrite(
    ...
    if (message.cameraParameters)
      CameraParameters.internalBinaryWrite(
        message.cameraParameters,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class TransformParameters$Type extends MessageType<TransformParameters> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* gooseai.TransformColorAdjust color_adjust */ 2:
          message.transform = {
            oneofKind: "colorAdjust",
            colorAdjust: TransformColorAdjust.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.transform as any).colorAdjust
            ),
          };
          break;
        case /* gooseai.TransformDepthCalc depth_calc */ 4:
          message.transform = {
            oneofKind: "depthCalc",
            depthCalc: TransformDepthCalc.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.transform as any).depthCalc
            ),
          };
          break;
        case /* gooseai.TransformResample resample */ 5:
          message.transform = {
            oneofKind: "resample",
            resample: TransformResample.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.transform as any).resample
            ),
          };
          break;
        case /* gooseai.TransformCameraPose camera_pose */ 6:
          message.transform = {
            oneofKind: "cameraPose",
            cameraPose: TransformCameraPose.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.transform as any).cameraPose
            ),
          };
          break;
        default:
  ...
  internalBinaryWrite(
    ...
    if (message.transform.oneofKind === "colorAdjust")
      TransformColorAdjust.internalBinaryWrite(
        message.transform.colorAdjust,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    /* gooseai.TransformDepthCalc depth_calc = 4; */
    if (message.transform.oneofKind === "depthCalc")
      TransformDepthCalc.internalBinaryWrite(
        message.transform.depthCalc,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options
      ).join();
    /* gooseai.TransformResample resample = 5; */
    if (message.transform.oneofKind === "resample")
      TransformResample.internalBinaryWrite(
        message.transform.resample,
        writer.tag(5, WireType.LengthDelimited).fork(),
        options
      ).join();
    /* gooseai.TransformCameraPose camera_pose = 6; */
    if (message.transform.oneofKind === "cameraPose")
      TransformCameraPose.internalBinaryWrite(
        message.transform.cameraPose,
        writer.tag(6, WireType.LengthDelimited).fork(),
        options
      ).join();
    let u = options.writeUnknownFields;
...
class AssetParameters$Type extends MessageType<AssetParameters> {
    ...
    super("gooseai.AssetParameters", [
      {
        ...
        name: "action",
        kind: "enum",
        T: () => ["gooseai.AssetAction", AssetAction],
      },
      { no: 2, name: "project_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
      {
        ...
        name: "use",
        kind: "enum",
        T: () => ["gooseai.AssetUse", AssetUse, "ASSET_USE_"],
      },
    ]);
  }
  ...
  internalBinaryWrite(
    ...
    if (message.use !== 0) writer.tag(3, WireType.Varint).int32(message.use);
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
...
class Answer$Type extends MessageType<Answer> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* optional gooseai.AnswerMeta meta */ 6:
          message.meta = AnswerMeta.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.meta
  ...
  internalBinaryWrite(
    ...
    if (message.meta)
      AnswerMeta.internalBinaryWrite(
        message.meta,
        writer.tag(6, WireType.LengthDelimited).fork(),
        options
      ).join();
      ...
      switch (fieldNo) {
        ...
        case /* repeated gooseai.Answer answers */ 2:
          message.answers.push(
            Answer.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
        default:
          let u = options.readUnknownField;
...
class Request$Type extends MessageType<Request> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated gooseai.Prompt prompt */ 4:
          message.prompt.push(
            Prompt.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
        case /* gooseai.ImageParameters image */ 5:
          message.params = {
            oneofKind: "image",
            image: ImageParameters.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.params as any).image
            ),
          };
          break;
        case /* gooseai.ClassifierParameters classifier */ 7:
          message.params = {
            ...
            classifier: ClassifierParameters.internalBinaryRead(
              ...
              reader.uint32(),
              options,
              (message.params as any).classifier
            ),
          };
          break;
        case /* gooseai.AssetParameters asset */ 8:
          message.params = {
            oneofKind: "asset",
            asset: AssetParameters.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.params as any).asset
            ),
          };
          break;
        case /* gooseai.InterpolateParameters interpolate */ 11:
          message.params = {
            oneofKind: "interpolate",
            interpolate: InterpolateParameters.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.params as any).interpolate
            ),
          };
          break;
        case /* gooseai.TransformParameters transform */ 12:
          message.params = {
            oneofKind: "transform",
            transform: TransformParameters.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.params as any).transform
            ),
          };
          break;
        case /* optional gooseai.ConditionerParameters conditioner */ 6:
          message.conditioner = ConditionerParameters.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.conditioner
  ...
  internalBinaryWrite(
    ...
    if (message.params.oneofKind === "image")
      ImageParameters.internalBinaryWrite(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated gooseai.FinishReason reason */ 1:
          ...
          else message.reason.push(reader.int32());
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* gooseai.Request request */ 2:
          message.request = Request.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.request
        ...
        case /* repeated gooseai.OnStatus on_status */ 3:
          message.onStatus.push(
            OnStatus.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
        default:
          let u = options.readUnknownField;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated gooseai.Stage stage */ 2:
          message.stage.push(
            Stage.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
        default:
          let u = options.readUnknownField;
