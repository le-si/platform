  ...
  constructor() {
    super("gooseai.OrganizationMember", [
      ...
      { no: 2, name: "user", kind: "message", T: () => User },
      {
        ...
        name: "role",
        kind: "enum",
        T: () => ["gooseai.OrganizationRole", OrganizationRole],
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* gooseai.Organization organization */ 1:
          message.organization = Organization.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
...
class OrganizationPaymentInfo$Type extends MessageType<OrganizationPaymentInfo> {
  ...
  create(
    value?: PartialMessage<OrganizationPaymentInfo>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: OrganizationPaymentInfo
  ): OrganizationPaymentInfo {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated gooseai.OrganizationGrant grants */ 2:
          message.grants.push(
            OrganizationGrant.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.grants.length; i++)
      OrganizationGrant.internalBinaryWrite(
        message.grants[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class OrganizationAutoCharge$Type extends MessageType<OrganizationAutoCharge> {
  ...
  create(
    value?: PartialMessage<OrganizationAutoCharge>
...
class Organization$Type extends MessageType<Organization> {
      ...
      switch (fieldNo) {
        ...
        case /* repeated gooseai.OrganizationMember members */ 4:
          message.members.push(
            OrganizationMember.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
        ...
        case /* optional gooseai.OrganizationPaymentInfo payment_info */ 5:
          message.paymentInfo = OrganizationPaymentInfo.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.paymentInfo
        ...
        case /* optional gooseai.OrganizationAutoCharge auto_charge */ 7:
          message.autoCharge = OrganizationAutoCharge.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.autoCharge
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.members.length; i++)
      OrganizationMember.internalBinaryWrite(
        message.members[i],
    ...
    if (message.paymentInfo)
      OrganizationPaymentInfo.internalBinaryWrite(
        message.paymentInfo,
    ...
    if (message.autoCharge)
      OrganizationAutoCharge.internalBinaryWrite(
        message.autoCharge,
      ...
      switch (fieldNo) {
        ...
        case /* repeated gooseai.APIKey api_keys */ 7:
          message.apiKeys.push(
            APIKey.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* gooseai.CostData input_cost */ 3:
          message.inputCost = CostData.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.inputCost
        ...
        case /* gooseai.CostData output_cost */ 4:
          message.outputCost = CostData.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.outputCost
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* gooseai.CostTotal input_total */ 1:
          message.inputTotal = CostTotal.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.inputTotal
        ...
        case /* gooseai.CostTotal output_total */ 2:
          message.outputTotal = CostTotal.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.outputTotal
...
class Metrics$Type extends MessageType<Metrics> {
      ...
      switch (fieldNo) {
        case /* repeated gooseai.UsageMetric metrics */ 1:
          message.metrics.push(
            UsageMetric.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
        case /* gooseai.TotalMetricsData total */ 2:
          message.total = TotalMetricsData.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.total
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.metrics.length; i++)
      UsageMetric.internalBinaryWrite(
        message.metrics[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.total)
      TotalMetricsData.internalBinaryWrite(
        message.total,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class GetOrganizationRequest$Type extends MessageType<GetOrganizationRequest> {
  ...
  create(
    value?: PartialMessage<GetOrganizationRequest>
...
class GetMetricsRequest$Type extends MessageType<GetMetricsRequest> {
  constructor() {
    super("gooseai.GetMetricsRequest", [
      ...
      {
        no: 5,
        name: "include_per_request_metrics",
        kind: "scalar",
        T: 8 /*ScalarType.BOOL*/,
      },
    ]);
  ...
  create(value?: PartialMessage<GetMetricsRequest>): GetMetricsRequest {
    const message = {
      ...
      rangeFrom: 0n,
      rangeTo: 0n,
      includePerRequestMetrics: false,
    };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {
      enumerable: false,
      value: this,
...
class UpdateDefaultOrganizationRequest$Type extends MessageType<UpdateDefaultOrganizationRequest> {
  ...
  create(
    value?: PartialMessage<UpdateDefaultOrganizationRequest>
    ...
    if (value !== undefined)
      reflectionMergePartial<UpdateDefaultOrganizationRequest>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: UpdateDefaultOrganizationRequest
  ): UpdateDefaultOrganizationRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
export const UpdateDefaultOrganizationRequest =
  new UpdateDefaultOrganizationRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class CreateAutoChargeIntentRequest$Type extends MessageType<CreateAutoChargeIntentRequest> {
  ...
  create(
    value?: PartialMessage<CreateAutoChargeIntentRequest>
    ...
    if (value !== undefined)
      reflectionMergePartial<CreateAutoChargeIntentRequest>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: CreateAutoChargeIntentRequest
  ): CreateAutoChargeIntentRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
 ...
 */
export const CreateAutoChargeIntentRequest =
  new CreateAutoChargeIntentRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated gooseai.Charge charges */ 1:
          message.charges.push(
            Charge.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
        default:
          let u = options.readUnknownField;
...
class UserPasswordChangeTicket$Type extends MessageType<UserPasswordChangeTicket> {
  ...
  create(
    value?: PartialMessage<UserPasswordChangeTicket>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: UserPasswordChangeTicket
  ): UserPasswordChangeTicket {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
