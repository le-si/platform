...
class ProjectAsset$Type extends MessageType<ProjectAsset> {
  ...
  private binaryReadMap9(
    map: ProjectAsset["tags"],
    reader: IBinaryReader,
    options: BinaryReadOptions
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof ProjectAsset["tags"] | undefined,
      val: ProjectAsset["tags"][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            "unknown map entry field for field gooseai.ProjectAsset.tags"
          );
      }
    }
    map[key ?? ""] = val ?? "";
...
class Project$Type extends MessageType<Project> {
  constructor() {
    super("gooseai.Project", [
      ...
      { no: 3, name: "owner_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
      {
        ...
        name: "access",
        kind: "enum",
        T: () => ["gooseai.ProjectAccess", ProjectAccess, "PROJECT_ACCESS_"],
      },
      {
        no: 5,
        name: "status",
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* gooseai.ProjectAsset file */ 7:
          message.file = ProjectAsset.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.file
  ...
  internalBinaryWrite(
    ...
    if (message.file)
      ProjectAsset.internalBinaryWrite(
        message.file,
...
class QueryAssetsRequest$Type extends MessageType<QueryAssetsRequest> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated gooseai.ProjectAssetUse use */ 7:
          ...
          else message.use.push(reader.int32());
          break;
  ...
  private binaryReadMap9(
    map: QueryAssetsRequest["tags"],
    reader: IBinaryReader,
    options: BinaryReadOptions
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof QueryAssetsRequest["tags"] | undefined,
      val: QueryAssetsRequest["tags"][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            "unknown map entry field for field gooseai.QueryAssetsRequest.tags"
          );
      }
    }
    map[key ?? ""] = val ?? "";
  ...
  internalBinaryWrite(
    ...
    if (message.use.length) {
      writer.tag(7, WireType.LengthDelimited).fork();
      for (let i = 0; i < message.use.length; i++) writer.int32(message.use[i]);
      writer.join();
    }
...
class TagAssetsRequest$Type extends MessageType<TagAssetsRequest> {
  ...
  private binaryReadMap4(
    map: TagAssetsRequest["tags"],
    reader: IBinaryReader,
    options: BinaryReadOptions
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof TagAssetsRequest["tags"] | undefined,
      val: TagAssetsRequest["tags"][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            "unknown map entry field for field gooseai.TagAssetsRequest.tags"
          );
      }
    }
    map[key ?? ""] = val ?? "";
