...
export interface IDashboardServiceClient {
  ...
  getMetrics(
    ...
    options?: RpcOptions
  ): UnaryCall<GetMetricsRequest, Metrics>;
  /**
   * API key management
   *
  ...
  updateDefaultOrganization(
    input: UpdateDefaultOrganizationRequest,
    options?: RpcOptions
  ): UnaryCall<UpdateDefaultOrganizationRequest, User>;
  /**
  ...
  getClientSettings(
    input: EmptyRequest,
    options?: RpcOptions
  ): UnaryCall<EmptyRequest, ClientSettings>;
  /**
  ...
  setClientSettings(
    ...
    options?: RpcOptions
  ): UnaryCall<ClientSettings, ClientSettings>;
  /**
  ...
  updateUserInfo(
    ...
    options?: RpcOptions
  ): UnaryCall<UpdateUserInfoRequest, User>;
  /**
  ...
  createPasswordChangeTicket(
    input: EmptyRequest,
    options?: RpcOptions
  ): UnaryCall<EmptyRequest, UserPasswordChangeTicket>;
  /**
  ...
  createCharge(
    ...
    options?: RpcOptions
  ): UnaryCall<CreateChargeRequest, Charge>;
  /**
   * @generated from protobuf rpc: GetCharges(gooseai.GetChargesRequest) returns (gooseai.Charges);
   */
  getCharges(
    input: GetChargesRequest,
    options?: RpcOptions
  ): UnaryCall<GetChargesRequest, Charges>;
  /**
  ...
  createAutoChargeIntent(
    input: CreateAutoChargeIntentRequest,
    options?: RpcOptions
  ): UnaryCall<CreateAutoChargeIntentRequest, AutoChargeIntent>;
  /**
   ...
   */
  getAutoChargeIntent(
    input: GetAutoChargeRequest,
    options?: RpcOptions
  ): UnaryCall<GetAutoChargeRequest, AutoChargeIntent>;
}
/**
 * @generated from protobuf service gooseai.DashboardService
 */
export class DashboardServiceClient
  implements IDashboardServiceClient, ServiceInfo
{
  ...
  getMe(
    ...
    return stackIntercept<EmptyRequest, User>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  getOrganization(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<GetOrganizationRequest, Organization>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  getMetrics(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<GetMetricsRequest, Metrics>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  createAPIKey(
    ...
    const method = this.methods[3],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<APIKeyRequest, APIKey>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  deleteAPIKey(
    ...
    const method = this.methods[4],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<APIKeyFindRequest, APIKey>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  updateDefaultOrganization(
    ...
    const method = this.methods[5],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<UpdateDefaultOrganizationRequest, User>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  getClientSettings(
    ...
    const method = this.methods[6],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<EmptyRequest, ClientSettings>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  setClientSettings(
    ...
    const method = this.methods[7],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<ClientSettings, ClientSettings>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  updateUserInfo(
    ...
    const method = this.methods[8],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<UpdateUserInfoRequest, User>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  createPasswordChangeTicket(
    ...
    const method = this.methods[9],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<EmptyRequest, UserPasswordChangeTicket>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  createCharge(
    ...
    const method = this.methods[11],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<CreateChargeRequest, Charge>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  getCharges(
    ...
    const method = this.methods[12],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<GetChargesRequest, Charges>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  createAutoChargeIntent(
    ...
    const method = this.methods[13],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<CreateAutoChargeIntentRequest, AutoChargeIntent>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  getAutoChargeIntent(
    ...
    const method = this.methods[15],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<GetAutoChargeRequest, AutoChargeIntent>(
      "unary",
      this._transport,
      method,
      opt,
